...
DEFINE FRAME gDialog
     vCodCliente AT ROW 1.33 COL 8 COLON-ALIGNED WIDGET-ID 10
     vNomCliente AT ROW 1.33 COL 22.72 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     br_docs AT ROW 3.25 COL 2 WIDGET-ID 200
     Btn_OK AT ROW 10.5 COL 3 WIDGET-ID 12
     btUpload AT ROW 10.5 COL 20 WIDGET-ID 14
     btRemove AT ROW 10.5 COL 41.14 WIDGET-ID 16
     RECT-1 AT ROW 1.08 COL 1.29 WIDGET-ID 6
     SPACE(0.70) SKIP(9.41)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Documentos do cliente" WIDGET-ID 100.
